...
class _ThemeSelectionListState extends State<ThemeSelectionList> {
  ...
  double get scrollOffset {
    final contentWidth = ThemeVariantPicker.itemSize * AppColors.allSwatches.length;
    ...
    return ListView(
      ...
      children: [
        for (final color in allColors)
          ThemeVariantPicker(
            color: color,
            isSelected: widget.currentThemeSettings.colorIndex == allColors.indexOf(color),
            ...
            onColorSelected: (color) {
              ...
              if (previousIndex != newIndex) {
                ...
                final newVariantIndex = (widget.currentThemeSettings.variantIndex + 1) % 3;
